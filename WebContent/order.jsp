...
if (custId == null || custId.equals("") || !String.valueOf(custId).equals((String)session.getAttribute("loggedInCustomerId")))
...
else
{
	...
	String trueCustId = null;
	String sql = null;
	
	try
	{
	trueCustId = (String)session.getAttribute("loggedInCustomerId");
	if(trueCustId.equals(String.valueOf(custId)))
